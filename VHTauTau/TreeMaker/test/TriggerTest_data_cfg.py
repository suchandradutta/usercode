...
## --
process.load("VHTauTau.TreeMaker.TriggerMatchProducer_cfi")
from PhysicsTools.PatAlgos.tools.trigTools import *
switchOnTrigger( process, outputModule='' ) # This is optional and can be omitted.
switchOnTriggerMatching( process, triggerMatchers = [ 'matchHLTMuons' ], outputModule='' )
