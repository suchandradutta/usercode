...
void JetBenchmark::setParameters( const edm::ParameterSet & parameterSet) {
...
void JetBenchmark::setDirectory(TDirectory* dir) {
...
void JetBenchmark::fillOne(const reco::Jet& jet,
  ...
  std::cout << " here " << pfJet << " " << pfMatchedJet << std::endl;
